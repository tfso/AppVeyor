...
class Workspace extends events.EventEmitter {
    ...
    upgrade() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield command_1.Command.execute(['framework', 'upgrade', 'ext', this.sdk || "ext"], this.output.bind(this), this.workspace);
    ...
    install() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield command_1.Command.execute(['framework', 'add', 'ext', this.sdk || "ext"], this.output.bind(this), this.workspace);
                this.emit('close', 0, null);
            }
            catch (ex) {
                this.emit('close', ex.code || -1, ex);
