...
(function (Appveyor) {
    ...
    var BuildWorker = (function () {
        ...
        BuildWorker.addArtifact = function (name, source, filename, type) {
            ...
            BuildWorker.getInstance()
                .request
                .post('api/artifacts', { name: name, path: dir, fileName: filename || location.base, type: (type ? ArtifactType[type] : ArtifactType[ArtifactType.Auto]) }, function (err, response, body) {
                if (err)
