...
(function (Appveyor) {
    ...
    var BuildWorker = (function () {
        ...
        BuildWorker.addArtifact = function (name, source, filename, type, cb) {
            ...
            BuildWorker.getInstance()
                .request
                .post('api/artifacts', { name: name, path: dir, fileName: filename || location.base, type: (type ? ArtifactType[type] : ArtifactType[ArtifactType.Auto]) }, function (err, response, options) {
