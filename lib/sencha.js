...
(function (Sencha) {
    ...
    var Module = (function (_super) {
        ...
        Module.prototype.build = function (callback) {
            var _this = this;
            var execute = new Promise(function (resolve, reject) {
                var newversion = appveyor_1.default.getBuildVersion(_this.type == ModuleType.Package ? _this.version : null).toString();
                _this.emit('stdout', 'Building "\u001b[36m' + _this.name + '\u001b[39m"\n');
                _this.emit('stdout', 'Patching from version ' + _this.version + ' to ' + newversion + '\n');
