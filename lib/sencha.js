...
(function (Sencha) {
            ...
            var execute = new Promise(function (resolve, reject) {
                ...
                _this
                    ...
                    modules.forEach(function (module) {
                        _this.emit('stdout', 'Found ' + (module.type == ModuleType.Package ? 'package' : 'application') + ' "\u001b[01m\u001b[36m' + module.name + '\u001b[0m" at "' + path.dirname(module.location) + '"\n');
    ...
    var Module = (function (_super) {
        ...
        Module.prototype.build = function (callback) {
            var _this = this;
            var execute = new Promise(function (resolve, reject) {
                _this.emit('stdout', 'Building "\u001b[01m\u001b[36m' + _this.name + '\u001b[0m"\n');
