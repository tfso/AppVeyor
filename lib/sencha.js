                    ...
                    modules.forEach(function (module) {
                        switch (module.type) {
                            case ModuleType.Application:
                                appveyor_1.default.BuildWorker.addArtifact(module.name, path.normalize(buildPath + 'production/' + module.name + '/'), module.name + ".zip", appveyor_1.default.ArtifactType.Zip);
                                break;
                            case ModuleType.Package:
                                appveyor_1.default.BuildWorker.addArtifact(module.name, path.normalize(buildPath + module.name + '/' + module.name + ".pkg"), module.name + ".pkg", appveyor_1.default.ArtifactType.Auto);
                                break;
                        }
                    });
                    _this.emit('close', 0);
