    ...
    var Module = (function (_super) {
        ...
        Module.prototype.build = function (callback) {
            ...
            var execute = new Promise(function (resolve, reject) {
                ...
                _this.emit('stdout', 'Patching from version ' + _this.version + ' to ' + appveyor_1.default.getBuildVersion(_this.version).toString() + '\n');
                patch_version_1.default(_this.location, appveyor_1.default.getBuildVersion(_this.version).toString(), null, null, function () {
                    _this.emit('stdout', 'Patched\n');
