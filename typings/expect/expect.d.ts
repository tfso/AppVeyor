...
//declare function spyOn(object: Object, methodName: string): Expect.Spy;
//declare function isSpy(object: any): Boolean;
//declare function restoreSpies(): void;
//declare function assert(condition: any, messageFormat: string, ...extraArgs: Array<any>): void;
//declare function extend(extension: Expect.Extension): void;
